...
$table_info_split = explode(SSHDB_EXPLODE1,$backup_split[0]);
$sshdb_return['table'] = $table_info_split;
str_replace(SSHDB_EXPLODE_STACK, '[[BIG_DATA]]',str_replace(SSHDB_EXPLODE2, '
...
for($j=0;$j<$var_count;$j++){
	...
	$sshdb_return['var'][$j] = $var_content_split;
}
...
for($k=0;$k<$ele_count;$k++){
	$ele_content_split = explode(SSHDB_EXPLODE1,$ele_split[$k]);
		...
		$sshdb_return['ele'][$k] = $ele_content_real_split;
}
