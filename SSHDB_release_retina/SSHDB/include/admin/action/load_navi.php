...
foreach(sshdb_list_storage() as $key => $value){
	?>
	<div id="navi_list_<?=$key?>" class="navi_db"><img src="<?=SSHDBS_URL?>img/icon_db.gif" width="20" height="20" class="resol" alt="" /><?
	...
	?>
	<div id="navi_list_<?=strlen($key)?>_<?=$key?><?=$keys?>" class="navi_tb"><div id="navi_list_a_<?=strlen($key)?>_<?=$key?><?=$keys?>" class="navi_tb_a"><img src="<?=SSHDBS_URL?>img/icon_tb.gif" width="20" height="20" class="resol" alt="" /><?
