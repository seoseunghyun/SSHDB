...
<!--	< div id="search_wrap"><input id="search_input" ></div> -->
	...
	<div id="content">
		...
		<div id="ts_textarea_wrap">
			...
			<div id="ts_textarea_title"><img src="<?=SSHDBS_URL?>img/ts_textarea_title.gif" class="presol" width="132" height="21" alt="Modify Value" /><div id="ts_textarea_status"></div></div>
