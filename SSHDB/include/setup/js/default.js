...
$(document).ready(function(){var sshdbs_action='include/setup/action/';var content_wrap_now=1;if(sshdb_client_phpversion>=5.1){$('#check_php').css({'background-position':'-46px'});$('#check_php').addClass('check_on');}
